...
public class DataDogUtils {
     ...
     * suite, not once per test — keeping the DataDog usage within free-tier limits
     * and making the resulting time-series human-readable on dashboards.
     *
     ...
     * @param framework  short label for the framework tag, e.g. {@code "selenium-java"}
     */
